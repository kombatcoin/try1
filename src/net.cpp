...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "KombatKoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"kombatkoin.io", "dnsseed.kombatkoin.io"},
    {"kombatkoin.qa", "dnsseed.kombatkoin.qa"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"kombatkoin.io", "testnet-seed.kombatkoin.io"},
    {"kombatkoin.qa", "testnet-seed.kombatkoin.qa"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. KombatKoin is probably already running."), addrBind.ToString().c_str());
        else
